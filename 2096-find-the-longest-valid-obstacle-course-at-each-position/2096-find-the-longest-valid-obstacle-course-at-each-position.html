<h1>2096 - Find the Longest Valid Obstacle Course at Each Position</h1><h2>Difficulty: Hard - <a href="https://leetcode.com/problems/find-the-longest-valid-obstacle-course-at-each-position/">find-the-longest-valid-obstacle-course-at-each-position</a></h2><p>You want to build some obstacle courses. You are given a <strong>0-indexed</strong> integer array <code>obstacles</code> of length <code>n</code>, where <code>obstacles[i]</code> describes the height of the <code>i<sup>th</sup></code> obstacle.</p>
